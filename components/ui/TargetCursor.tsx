...
export default function TargetCursor({
  ...
  // Exploits the fact that a React ref is already a { current } object gsap
  // can tween directly — gsap.to(activeStrengthRef, {current: 1, ...}) mutates
  // activeStrengthRef.current over time, no separate tween-target needed.
