...
// app/api/documents/gtm/route.ts, including its ownership check (lib/db/documents.ts
// has no org/user awareness of its own). TDS has no regenerate endpoint
// anywhere in this API surface — that's how "no regenerate" is enforced.
